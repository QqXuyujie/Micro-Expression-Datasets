...
class Config(object):
    def __init__(self):
        ...
        self.dir_baby = os.path.join(self.data_dir, 'training/baby')
        ...
        self.dir_myself = os.path.join(self.data_dir, 'vids/casme2')  # /
