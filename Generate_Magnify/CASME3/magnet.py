...
class Manipulator(nn.Module):
    ...
    def forward(self, motion_A, motion_B, amp_factor):
        motion_A = F.interpolate(motion_A, size=(375, 324), mode='bilinear', align_corners=False)
        motion_B = F.interpolate(motion_B, size=(375, 324), mode='bilinear', align_corners=False)
